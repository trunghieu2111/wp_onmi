...
if ( ! empty( $tm_font_weight ) ) {
    $styles[] = 'font-weight: ' . $tm_font_weight;
}
if ( ! empty( $tm_text_transform ) ) {
    $styles[] = 'text-transform: ' . $tm_text_transform;
}
if ( ! empty( $tm_letter_spacing ) ) {
    $styles[] = 'letter-spacing: ' . $tm_letter_spacing;
}
