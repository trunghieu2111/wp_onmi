<?php
/**
 * Vandana Lite Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Vandana_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Vandana_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'vandana-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'vandana-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'vandana-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
