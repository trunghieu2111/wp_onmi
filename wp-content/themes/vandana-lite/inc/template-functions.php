...
function vandana_lite_content_start(){       
    ...
    if( ! ( is_front_page() && ! is_home() && $home_sections ) ){ //Make necessary adjust for pg template.
        ...
        if( is_single() && !( ( vandana_lite_is_woocommerce_activated() && is_product() ) || ( vandana_lite_is_bttk_activated() && is_singular( 'blossom-portfolio' ) ) ) ) vandana_lite_single_entry_header();
