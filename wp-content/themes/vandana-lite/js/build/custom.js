jQuery(document).ready(function($) {
    ...
    $('.mobile-header .mbl-menu-wrap .close').click(function () {
    ...
    $('.main-navigation ul li a, .secondary-menu ul li a, .main-navigation ul li button, .secondary-menu ul li button').focus(function() {
